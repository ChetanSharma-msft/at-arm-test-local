    ...
    public class GraphApiHelper : ITeamMembership, IUserProfile
    {
        ...
        public async Task<List<User>> GetGroupMemberDetailsAsync(string token, string groupId)
        {
            ...
            if (members != null)
            {
                ...
                this.memoryCache.Set(this.GetSecurityGroupCacheKey(groupId), groupMembers, TimeSpan.FromMinutes(this.botSettings.Value.CacheDurationInMinutes));
        ...
        {
            return $"{groupId}{CacheKeysConstants.SecurityGroup}";
        }
