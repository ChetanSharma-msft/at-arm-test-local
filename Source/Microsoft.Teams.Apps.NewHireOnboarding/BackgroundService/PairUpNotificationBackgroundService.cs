...
#pragma warning restore CA1031 // Catching general exceptions that might arise during execution to avoid blocking next run.
        ...
        private async Task NotifyPairAsync(UserEntity person1, UserEntity person2)
        {
            ...
            await this.cardHelper.SendProActiveNotificationCardAsync(cardForPerson1, person1.ConversationId, person1.ServiceUrl);
            await this.cardHelper.SendProActiveNotificationCardAsync(cardForPerson2, person2.ConversationId, person2.ServiceUrl);
