...
namespace Microsoft.Teams.Apps.NewHireOnboarding.Cards
{
    ...
    {
        /// <summary>
        /// Represents introduction image height in pixel.
        /// </summary>
        private const int IntroductionImageHeight = 110;

        /// <summary>
        /// Represents introduction image width in pixel.
        /// </summary>
        private const int IntroductionImagewidth = 500;
            ...
            AdaptiveCard card = new AdaptiveCard(new AdaptiveSchemaVersion(CardConstants.AdaptiveCardVersion))
            {
                Body = new List<AdaptiveElement>
                {
                    new AdaptiveImage
                    {
                        ...
                        PixelHeight = IntroductionImageHeight,
                        PixelWidth = IntroductionImagewidth,
                    },
                },
            };
