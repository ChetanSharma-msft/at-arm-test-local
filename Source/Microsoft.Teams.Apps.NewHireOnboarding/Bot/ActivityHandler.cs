        ...
        where T : Dialog
    {
            ...
            else
            {
                switch (command.ToUpperInvariant())
                {
                    ...
                    case BotCommandConstants.SeeIntroductionDetailAction:
                        return this.cardHelper.GetIntroductionDetailCardForTeam(postedValues.IntroductionEntity);
        ...
        protected override async Task OnMessageActivityAsync(ITurnContext<IMessageActivity> turnContext, CancellationToken cancellationToken)
        {
            ...
            if (activity.Conversation.ConversationType == CardConstants.PersonalConversationType)
            {
                ...
                if (command.Equals(this.localizer.GetString("ShareFeedbackText").ToString().ToUpperInvariant(), StringComparison.InvariantCultureIgnoreCase))
                {
                ...
                else if (command.Equals(this.localizer.GetString("SubmitFeedbackText").ToString().ToUpperInvariant(), StringComparison.InvariantCultureIgnoreCase))
                {
                ...
                else if (command.Equals(this.localizer.GetString("OnBoardingCheckListText").ToString().ToUpperInvariant(), StringComparison.InvariantCultureIgnoreCase))
                {
                ...
                else if (command.Equals(this.localizer.GetString("LogoutText").ToString().ToUpperInvariant(), StringComparison.InvariantCultureIgnoreCase))
                {
                    await this.dialog.RunAsync(turnContext, this.conversationState.CreateProperty<DialogState>(nameof(DialogState)), cancellationToken);
                ...
                else if (command.Equals(this.localizer.GetString("RequestMoreInfoText").ToString().ToUpperInvariant(), StringComparison.InvariantCultureIgnoreCase))
                {
                ...
                else if (command.Equals(this.localizer.GetString("HelpText").ToString().ToUpperInvariant(), StringComparison.InvariantCultureIgnoreCase))
                {
                    var userDetail = await this.userStorageProvider.GetUserDetailAsync(activity.From.AadObjectId);
                ...
                else if (command.Equals(this.localizer.GetString("ReviewIntroductionText").ToString().ToUpperInvariant(), StringComparison.InvariantCultureIgnoreCase))
                {
                    ...
                    for (int batchIndex = 0; batchIndex < batchCount; batchIndex++)
                    {
                        ...
                        var listCardAttachment = await this.cardHelper.GetReviewIntroductionListCardAsync(batchWiseIntroductionEntities, userGraphAccessToken);
                ...
                else if (command.Equals(this.localizer.GetString("ViewLearningText").ToString().ToUpperInvariant(), StringComparison.InvariantCultureIgnoreCase))
                {
                    var userDetail = await this.userStorageProvider.GetUserDetailAsync(activity.From.AadObjectId);
                ...
                else if (command.Equals(BotCommandConstants.ResumeAllMatches.ToUpperInvariant(), StringComparison.InvariantCultureIgnoreCase)
                    || command.Equals(BotCommandConstants.PauseAllMatches.ToUpperInvariant(), StringComparison.InvariantCultureIgnoreCase))
                {
                ...
                switch (command.ToUpperInvariant().Trim())
                {
                    ...
                    case BotCommandConstants.PostTeamNotificationAction:
                        ...
                        if (isIntroductionApproved)
                        {
                            ...
                            await this.cardHelper.SendProActiveNotificationCardAsync(teamNotificationAttachment, valuesFromTaskModule.TeamId.Split(";")[1], activity.ServiceUrl);
                        ...
                        {
                            await turnContext.SendActivityAsync(this.localizer.GetString("ErrorMessage"));
                            this.logger.LogError("Unable to update new hire introduction details into table storage.");
                        }
