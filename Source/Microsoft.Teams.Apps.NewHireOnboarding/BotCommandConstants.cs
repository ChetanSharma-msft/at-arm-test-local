// <copyright file="BotCommandConstants.cs" company="Microsoft">
...
{
    /// <summary>
    /// A class that holds bot command constants that are used in multiple files.
    /// </summary>
    public static class BotCommandConstants
    {
        ...
        /// <summary>
        /// See introduction detail action.
        /// </summary>
        public const string SeeIntroductionDetailAction = "SEE INTRODUCTION DETAILS";
